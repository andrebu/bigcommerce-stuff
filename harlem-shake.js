...
var harlemShakeBtn = '<button class="btn Small" id="harlem-shake">Harlem Shake!</button>';
$('#subHeader .PageMenu li:last-child a').replaceWith(harlemShakeBtn);
$('#harlem-shake').on('click', function(e){e.preventDefault();harlemShakeFunc();});
